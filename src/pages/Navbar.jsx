...
const Navbar = () => {
  ...
  return (
    <div className="flex items-center justify-between  md:flex">
      ...
      <nav
        className={`absolute top-20 list-none items-center gap-5 rounded-lg bg-[#343537] px-24 py-10 text-center text-white shadow-lg md:static md:left-[40%]   md:flex md:rounded-none md:bg-transparent md:p-0 md:text-black   md:shadow-none ${
